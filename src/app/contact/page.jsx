...
const form = useRef();
 ...
 return (
    ...
    <div className="h-screen flex flex-col items-center px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        {/* TEXT CONTAINER */}
        <div className="py-7 lg:w-1/2 flex items-center justify-center text-white text-3xl lg:text-6xl xl:text-6xl">
        ...
        <form
            onSubmit={sendEmail} 
            ref={form} className="h-[75%] w-[90%] pb-10 bg-borgonia rounded-xl text-neonYellow font-bold text-lg md:text-xl flex flex-col gap-4 justify-center p-10 sm:p-18 md:p-19 lg:px-20 lg:py-15">
            ...
            <span>Regards.</span>
            <button className="bg-purple-700 rounded font-semibold text-neonBlue p-4">Send</button>
            {success && <span className="text-neonGreen font-semibold">Your message has been sent succesfully!</span>}
